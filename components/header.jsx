...
export default async function Header() {
  ...
  return (
    <header className="fixed top-0 w-full border-b  bg-white/5 backdrop-blur-md
...
>
  <DropdownItem href="/resume" icon={FileText} label="Build Resume" />
  <DropdownItem href="/ai-cover-letter" icon={PenBox} label="Cover Letter" />
  <DropdownItem href="/interview" icon={GraduationCap} label="Interview Prep" />
</DropdownMenu>
